...
const Header = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 [transition:padding_300ms_ease,background-color_300ms_ease,box-shadow_300ms_ease] ${isScrolled ? 'py-3 bg-white shadow-md' : 'py-5 bg-transparent'}`}>
